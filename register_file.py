...
class RegisterFile:
    ...
    def __init__(self):
        ...
        self.registers = []
        # I hard coded this at first but then noticed the constant
        # Magic numbers bad
    ...
    def _read(self, ra, rb):
        ...
        if ra is None and rb is None:
            ...
            if self._check_index(ra) and self._check_index(rb):
                values = (self.registers[ra].value, self.registers[rb].value)
        else:
            if self._check_index(ra):
                values = (self.registers[ra].value, None)
        return values
